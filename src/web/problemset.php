...
if(isset($_GET["cat"]) && $_GET["cat"] != "all") {
    $cat = $_GET["cat"];
    if($cat == "c") $filter_sql .= " AND problem_id BETWEEN 1 AND 100";
    else if($cat == "cadv") $filter_sql .= " AND (problem_id BETWEEN 101 AND 999 OR problem_id BETWEEN 9000 AND 9999)";
    else if($cat == "py") $filter_sql .= " AND problem_id BETWEEN 1000 AND 1999";
}
