...
$(document).ready(function(){
  ...
  //+ Footer
  if(!$(".codit-global-footer").length) $("body").append("<div class=\"codit-global-footer\"><div class=\"cgf-inner\"><span>© "+(new Date()).getFullYear()+" Codit · <a href=\"https://school.cbe.go.kr/chungju-h/\" target=\"_blank\">충주고등학교</a> 정보교사 박지훈</span><span class=\"cgf-sep\">|</span><a href=\"privacy.php\">개인정보처리방침</a><span class=\"cgf-sep\">|</span><a href=\"mailto:wlgnsdl122@naver.com\">wlgnsdl122@naver.com</a></div></div>");
  //- Footer
